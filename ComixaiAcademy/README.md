...
仕掛け**として体験カードを挟みます。17本中10本に入っています。

| 種類 | 何をする | 入っているレッスン |
|---|---|---|
| `sort` | 流れてくる1枚を左右の箱に振り分ける | basics-3 / risk-1 / next-1 / next-3 |
| `find` | 文書の危ない行をタップして摘発する | risk-3 |
| `build` | 部品を選ぶと出力がその場で変わる | basics-2 / prompt-3 |
| `fit` | 限られた広さに、要る資料だけ載せる | basics-4 |
