/* ============================================================
   ...
   ▍体験カードは全部、通らないと先へ進めない
   もとは token-budget だけが必須だったが、任意にすると遊ばれずに
   「読むだけで修了」が積み上がる（実機で指摘）。いまは全ゲームが
   修了の条件（→ app/lesson/[id].tsx の gated）。
   ai-prompt はAIに繋がらないとき簡易採点に降格する（lib/grade.ts）ので、
   電波が無くても必ず抜けられる。
   ============================================================ */
