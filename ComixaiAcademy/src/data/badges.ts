...
/** 上から順に、条件を満たす最上位が現在の称号になる。
    ...
    ノーミスだと1本目で4つ（quiz-perfect ぶん）入るので、
    次の「AIの相棒」は5から。ここを4に戻すと2段いっぺんに上がってしまう。 */
export const TITLES: Title[] = [
  { need: 0, icon: 'egg', name: 'AI見習い', say: 'まあ、そこからだな。' },
  { need: 3, icon: 'learn', name: 'AI研修生', say: '研修生に上げておく。まだ何も覚えてないが。' },
  { need: 5, icon: 'buddy', name: 'AIの相棒', say: '相棒、か。悪くない響きだ。' },
  { need: 7, icon: 'hammer', name: 'AI使い', say: '道具として使えてる。ここからが面白い。' },
