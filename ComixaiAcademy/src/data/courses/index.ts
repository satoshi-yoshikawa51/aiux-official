  ...
  return [
    ...lesson.cards,
    {
      /* セリフは職種に触れない。触れると roleNote と同じことを二度言う。
         ...
         ▍相棒別を必ず書く
         このカードは全17レッスンの締めに出る＝**いちばん目にするセリフ**。
         ここが先輩の口調のままだと、おっとりを選んだ人の画面で毎回
         別人がしゃべる（実機で指摘）。データ側のカードと同じく5人ぶん書く */
      say: 'ここまでは全員に同じ話をした。あなたの現場だと、こうなる。',
      sayByAvatar: {
        ottori: 'ここまでは、みなさんに同じお話をしてきました。あなたの現場だと、こうなりますよ。',
        nekketsu: 'ここまでは全員に同じ話をした。ここからだ——きみの現場だと、こうなるぜ。',
        otenba: 'ここまではみんな同じ話ね。あなたの現場だと、こうなるの。',
        kanroku: 'ここまでは全員に同じ話をしてきた。きみの現場だと、こうなるよ。',
        neko: 'ここまでは、みんなにおなじ話をしてきたんだ。きみのげんばだと、こうなるよ！',
      },
      motion: 'explain',
      emote: 'compass',
      heading: 'あなたの現場だと',
