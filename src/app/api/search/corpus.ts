...
const PAGES: SearchDoc[] = [
  ...
  { id: "page:glossary", type: "ページ", title: "AI用語集", url: "/glossary", text: "生成AI・LLM・RAG・AIエージェントなど、いまさら聞けないAI用語50語を図解つき・現場目線で解説する用語集。" },
  ...
  { id: "page:zukan", type: "ページ", title: "COMIXAI図鑑", url: "/zukan", text: "サイト内のゲームや診断で解放した項目が記録されるコレクション図鑑。全63項目。隠し部屋は全部で12ある。" },
