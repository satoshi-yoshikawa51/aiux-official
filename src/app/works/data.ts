...
export const WORK_DETAILS: WorkDetail[] = [
  {
    ...
    intro: [
      ...
      "実はこのゲーム、ふだんClaudeで作っているこのサイトに並ぶ、初のChatGPT製作品。2026年9月に登場したGPT-6 AstraをChatGPT Work（自律エージェント）で動かし、「このサイトの1コンテンツとして超高クオリティの3Dゲームを作って」という一発の指示から生まれ、ChatGPT Sitesでそのまま公開しました。道具を1社に決めず、そのとき一番良いものを選ぶ——当サイトのそんな方針の実践例でもあります。どう作ったかは、下の制作ストーリーでどうぞ。",
    ],
    features: [
      {
