...
const DIAGRAMS: Record<string, { caption: string; render: () => React.ReactNode }> = {
  ...
  "space-data-center": {
    caption: "電気が要らなくなるのではなく、電気の取り方を変える",
    render: () => (
      <Svg h={302} title="地上のデータセンターと宇宙データセンターの違いの図解">
        <T x={300} y={30} text="地上：電気と水を買って冷やす" size={13} />
        <B x={30} y={46} w={150} h={60} label={"電気を買う"} />
        <AH x1={185} x2={225} y={76} />
        <B x={230} y={46} w={150} h={60} label={"サーバー"} />
        <AH x1={385} x2={425} y={76} />
        <B x={430} y={46} w={150} h={60} label={"水と電気で\n冷やす"} />
        <T x={300} y={130} text="軌道上：太陽光でまかない、熱は宇宙へ捨てる" size={13} />
        <B x={30} y={146} w={150} h={60} label={"太陽光"} sub="ほぼ24時間" fill={YELLOW} />
        <AH x1={185} x2={225} y={176} />
        <B x={230} y={146} w={150} h={60} label={"TPUを積んだ\n衛星"} fill={YELLOW} />
        <AH x1={385} x2={425} y={176} />
        <B x={430} y={146} w={150} h={60} label={"熱は宇宙へ"} fill={YELLOW} />
        <T x={300} y={248} text="同じ太陽電池でも地上の最大8倍の発電量になるとGoogleは説明" size={13} />
        <T x={300} y={276} text="2026年10月1日、まずTPU4基の試作機で「壊れないか」を確かめる" size={13.5} color={INK} />
      </Svg>
    ),
  },
  "ai-avatar": {
    caption: "顔が見えるから本物、とは限らない",
    render: () => (
      <Svg h={340} title="声だけのAIとAIアバターの違いの図解">
        <T x={300} y={30} text="これまで：声だけが返ってくる" size={13} />
        <B x={30} y={46} w={150} h={58} label={"あなたが話す"} />
        <AH x1={185} x2={225} y={75} />
        <B x={230} y={46} w={150} h={58} label={"AIが考える"} />
        <AH x1={385} x2={425} y={75} />
        <B x={430} y={46} w={150} h={58} label={"声で返す"} />
        <T x={300} y={130} text="いま：会話しながら、映像もその場で作る" size={13} />
        <B x={30} y={146} w={150} h={58} label={"あなたが話す"} fill={YELLOW} />
        <AH x1={185} x2={225} y={175} />
        <B x={230} y={146} w={150} h={58} label={"AIが考える"} fill={YELLOW} />
        <AH x1={385} x2={425} y={175} />
        <B x={430} y={146} w={150} h={58} label={"声＋顔で返す"} sub="しゃべりに合わせて動く" fill={YELLOW} />
        <AV x={505} y1={208} y2={238} />
        <B x={385} y={240} w={195} h={48} label={"電子透かし"} sub="AI生成だと確かめられる" dashed />
        <T x={300} y={316} text="人らしさを、信用の根拠にしない" size={13.5} color={INK} />
      </Svg>
    ),
  },
};
