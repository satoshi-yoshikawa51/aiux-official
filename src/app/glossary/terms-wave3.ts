...
export const TERMS_WAVE3: GlossaryTerm[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "Meta Connect 2026で「カメラなし」が出ました（追記）",
        body: [
          "上の注意点でプライバシーを挙げましたが、2026年9月23〜24日のMeta Connect 2026で、その論点に正面からこたえる製品が出ました。カメラを載せない「Ray-Ban Meta Audio」です。価格は349ドル、出荷は10月13日から。重さ43グラムとMetaのAIグラスでいちばん軽く、本体だけで最大12時間、充電ケース込みで48時間もちます。フレームはBurbankとClubmasterの2種類。カメラが要らない機能——AIとの会話、通話、メッセージの返信、音楽再生、リアルタイム翻訳——はひと通り使えます。日本での発売は2027年の予定と報じられています。",
          "同じ日に、カメラつきの本流も更新されました。「Ray-Ban Meta Gen 3」は449ドルで当日発売、1200万画素のカメラで3K動画が撮れ、マイクは6つ、バッテリーは最大9時間です。あわせて超薄型の「Meta VR Glasses」（1,299ドル・春発売予定）と、キーホルダー型のAI端末「Muse Charm」も発表されました。グラスに載るAIアシスタントは、Metaのパーソナルエージェント「Muse」です。",
          "読み方としては「カメラを外した廉価版が出た」より、「用途で系統が分かれはじめた」のほうが近いはずです。見たものを質問したい人はカメラつき、AIと話す・聞く・訳すだけでよい人はカメラなし——と選べるようになりました。周囲の視線が気になって手が出なかった人には、カメラなしのほうが生活に馴染みやすいでしょう。買う前に「自分はレンズ越しに質問したいのか、耳だけで足りるのか」を決めておくと、機種選びで迷わずに済みます。",
        ],
      },
    ],
    links: [
    ...
    relatedSlugs: ["multimodal-ai", "voice-assistant", "voice-ai", "edge-ai", "computer-vision", "ai-agent", "meta-muse"],
    faq: [
      {
      ...
      {
        q: "カメラのないAIグラスは何ができますか？",
        a: "AIとの音声での会話、通話、メッセージの返信、音楽やポッドキャストの再生、リアルタイム翻訳ができます。できないのは「見ているものをAIに見せて質問すること」と写真・動画の撮影です。2026年9月に発表されたRay-Ban Meta Audioが最初の例で、価格は349ドル、出荷は10月13日からです。",
      },
      {
        q: "Ray-Ban Meta Audioは日本で買えますか？",
        a: "2026年9月時点では最初の発売地域に日本は入っておらず、日本での提供は2027年の予定と報じられています。AIグラスは機能の日本語対応も地域ごとに差があるので、買う直前に最新の対応状況を確認するのが確実です。",
      },
    ],
