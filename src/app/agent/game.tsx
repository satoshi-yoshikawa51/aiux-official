        ...
        <Card variant="pop" padding={0} className="game-in" style={{ marginTop: 18, overflow: "hidden" }}>
          ...
          <div style={{ padding: "20px 24px 24px" }}>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
              <a href={intent} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }} data-ga="share_click" data-ga-network="x" data-ga-place="result" data-ga-path="/agent">
