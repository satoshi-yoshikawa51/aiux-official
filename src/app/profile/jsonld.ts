  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        { "@type": "Question", "name": "AI活用マンガはどこで読めますか？", "acceptedAnswer": { "@type": "Answer", "text": "note「AI-UX UNITE」（note.com/aiux_unite）で読めます。「マンガでわかる！AI活用」「マンガで実践！AI活用」「AI時代の流行と本質」の3マガジンを連載中。動画はYouTube @comixai-dev でも発信しています。" } },
