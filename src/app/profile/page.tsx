...
export const metadata: Metadata = {
  title: "吉川 聡史（よしかわ さとし）プロフィール｜AIクリエイター・漫画家・UXディレクター｜COMIXAI",
  description:
    "吉川聡史（よしかわさとし）のプロフィール。週刊少年チャンピオン連載の漫画家であり、株式会社ニジボックスの室長／UXディレクター。生成AI活用をマンガで伝えるAIクリエイターとして、note「COMIXAI」で「マンガでわかる！AI活用」などを連載。経歴・専門領域・実績を紹介します。",
  keywords: [
    "吉川聡史",
    "よしかわさとし",
    "COMIXAI",
