...
export const COMPARE_FAQ: { q: string; a: string }[] = [
  ...
  {
    q: "料金や性能はすぐ変わるのでは？",
    a: "変わります。実際2026年9月の第1週だけで、Claude Fable 5.1とGPT-6 Astraが相次いで登場しました。だからこそ「1社に忠誠を誓わず、いつでも乗り換えられる状態にしておく」のが最強の戦略。道具の操作ではなく、プロンプトの書き方やAIの性質という共通スキルを身につけておけば、乗り換えコストはほぼゼロです。",
  },
];
