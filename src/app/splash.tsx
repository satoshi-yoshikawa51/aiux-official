    ...
    <div className={"splash" + (out ? " splash-out" : "")} aria-hidden="true">
      ...
      <span className="splash-face">
        <svg width="100%" height="100%" viewBox="-32 0 264 190" style={{ display: "block", overflow: "visible" }}>
          ...
          <path
            fill="var(--paper-50)"
            d="M 34,68 C 26,50 22,28 26,16 C 27,11 32,11 36,15 C 44,22 54,32 61,39 C 72,34 86,32 100,32 C 114,32 128,34 139,39 C 146,32 156,22 164,15 C 168,11 173,11 174,16 C 178,28 174,50 166,68 C 182,84 194,104 194,120 C 194,140 180,154 158,163 C 141,170 120,173 100,173 C 80,173 59,170 42,163 C 20,154 6,140 6,120 C 6,104 18,84 34,68 Z"
          />
