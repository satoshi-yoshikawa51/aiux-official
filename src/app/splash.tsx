    ...
    <div className={"splash" + (out ? " splash-out" : "")} aria-hidden="true">
      ...
      <span className="splash-face">
        <svg width="100%" height="100%" viewBox="-32 0 264 190" style={{ display: "block", overflow: "visible" }}>
          ...
          <path
            fill="var(--paper-50)"
            d="M 28,66 C 25,50 23,28 26,18 C 28,13 32,13 35,17 C 44,25 54,33 62,39 C 73,34 87,32 100,32 C 113,32 127,34 138,39 C 146,33 156,25 165,17 C 168,13 172,13 174,18 C 177,28 175,50 172,66 C 185,81 194,104 194,120 C 194,140 180,154 158,163 C 141,170 120,173 100,173 C 80,173 59,170 42,163 C 20,154 6,140 6,120 C 6,104 15,81 28,66 Z"
          />
